...
public class FirefoxBrowser {
	...
	public WebDriver getFirefoxDriver(Capabilities cap) {
		System.setProperty("webdriver.gecko.driver",
				BrowserPath.Firefox.firefoxPath);
		System.setProperty("webdriver.gecko.logfile",
				BrowserPath.Firefox.firefoxLogPath + "firefoxlog"
						+ DateTimeHelper.getCurrentDateTime() + ".log");
		return new FirefoxDriver(cap);
	}

	public WebDriver getFirefoxDriver(String hubUrl, Capabilities cap)
