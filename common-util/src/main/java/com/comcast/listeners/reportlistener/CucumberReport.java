 ...
 *
 */
package com.comcast.listeners.reportlistener;
...
public class CucumberReport implements ISuiteListener {
	...
	public final Logger oLog = Logger.getLogger(CucumberReport.class);
	...
	public void onFinish(ISuite suite) {
		try {
			...
			File jsonfile = new File("target/");
			File reportOutputDirectory = new File("src/main/resources/reports/");
